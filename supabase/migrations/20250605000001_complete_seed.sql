-- =============================================================================
-- QR Order — Sample seed data (matches src/lib/constants.ts)
-- Prerequisite: 20250605000000_complete_schema.sql
-- =============================================================================
...
on conflict (restaurant_id, qr_code) do update
set
...
-- admin_users: create Auth user first, then:
-- insert into public.admin_users (id, restaurant_id, email, role, display_name)
-- values ('YOUR_AUTH_USER_UUID', '00000000-0000-0000-0000-000000000001', 'admin@demo.com', 'admin', 'Demo Admin');
